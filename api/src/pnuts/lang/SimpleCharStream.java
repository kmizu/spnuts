...
class SimpleCharStream {
	...
	private final static java.io.IOException eof = new java.io.IOException();
	...
	protected void ExpandBuff(boolean wrapAround) {
		int newbufferSize = (bufsize + 1) * 2;
		char[] newbuffer = new char[newbufferSize];
		int newbufline[] = new int[newbufferSize];
		int newbufcolumn[] = new int[newbufferSize];
	...
	protected void FillBuff() throws java.io.IOException {
		if (maxNextCharInd == available) {
			if (available == bufsize) {
				...
				available = bufsize;
			else if ((tokenBegin - available) < 128)
				ExpandBuff(true);
			else
				available = tokenBegin;
		}
...
//			break;
	...
	public void ReInit(java.io.Reader dstream, int startline, int startcolumn) {
		ReInit(dstream, startline, startcolumn, 512);
	}

	public void ReInit(java.io.Reader dstream) {
		ReInit(dstream, 1, 1, 512);
	}
	...
	public SimpleCharStream(java.io.InputStream in, String encoding, int startline, int startcolumn) throws java.io.UnsupportedEncodingException {
		this(new java.io.InputStreamReader(in, encoding), startline, startcolumn, 512);
	}
	...
	public void ReInit(java.io.InputStream in, String encoding, int startline, int startcolumn) throws java.io.UnsupportedEncodingException {
		ReInit(new java.io.InputStreamReader(in, encoding), startline, startcolumn);
	}
